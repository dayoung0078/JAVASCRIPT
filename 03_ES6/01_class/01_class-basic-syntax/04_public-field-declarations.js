...
class Book {
    ...
    /*!!!!!!!!!!!!!!!!!!!!!!!!!! this는 constructor, 메소드 내부에서만 작성해!!!!!!!!!!!!!!!!!!!!!!!!!!!  */

    price;

    introduce() { // 보통 객체의 정보를 다루거나, 객체의 상태를 설명하는 메소드
        console.log(`${this.name}(이)가 그렇게 재밌죠~`);
    }
    //  introduce() 메소드가 객체의 name 속성을 이용하여 해당 객체를 소개하는 문자열을 출력
}
...
console.log(book.price);    // undefined  // price는 그 어디에도 없다.
